...
namespace BegVCSharp_26_13_TakeAndSkip
{
    class Customer
    {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var queryResults =
               ...
               ;
            //method syntax:   var queryResults = customers.OrderByDescending(c => c.Sales).Select(c => new { c.ID, c.City, c.Country, c.Sales }).Take(5);
