...
namespace BegVCSharp_26_8_ProjectionCreateNewObjects
{
    class Customer
    {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var queryResults =
               ...
               ;
            //method syntax: var queryResults = customers.Where(c => c.Region == "North America").Select(c => new { c.City, c.Country, c.Sales });
