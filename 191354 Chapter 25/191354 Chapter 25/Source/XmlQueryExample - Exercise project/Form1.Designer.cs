namespace XmlQueryExample
{
   partial class Form1
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.radioButtonSearchForPages = new System.Windows.Forms.RadioButton();
         this.SuspendLayout();
         // 
         // buttonClose
         // 
         ...
         // 
         // radioButtonSearchForPages
         // 
         this.radioButtonSearchForPages.AutoSize = true;
         this.radioButtonSearchForPages.Location = new System.Drawing.Point(170, 295);
         this.radioButtonSearchForPages.Name = "radioButtonSearchForPages";
         this.radioButtonSearchForPages.Size = new System.Drawing.Size(106, 17);
         this.radioButtonSearchForPages.TabIndex = 12;
         this.radioButtonSearchForPages.TabStop = true;
         this.radioButtonSearchForPages.Text = "Search for pages";
         this.radioButtonSearchForPages.UseVisualStyleBackColor = true;
         this.radioButtonSearchForPages.CheckedChanged += new System.EventHandler(this.radioButtonSearchForPages_CheckedChanged);
         // 
         // Form1
         // 
         ...
         this.Controls.Add(this.radioButtonSearchForPages);
      ...
      private System.Windows.Forms.RadioButton radioButtonSearchForPages;
   }
}
